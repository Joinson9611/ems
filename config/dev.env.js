...
module.exports = merge(prodEnv, {
  ...
  // HEAD_IMAGE_URL: '"http://192.168.3.101/fiot/public/image/user_head/"',
  // TASK_IMAGE_URL: '"http://192.168.3.101/fiot/public"',
  // DEVICE_IMAGE_URL: '"http://192.168.3.101/fiot/public/image/device_type/"',
  // AD_IMAGE_URL: '"http://192.168.3.101/fiot/public/image/ad/"',
  // PROJECT_IMAGE_URL: '"http://192.168.3.101/fiot/public/image/project_head/"',
  // FILE_URL:'"http://192.168.3.101/fiot/public"',
  // BASE_API: '"http://192.168.3.101/fiot/public/index.php/web/v1/"'
