...
export default {
  ...
  data() {
    return {
      ...
      alarmOptions: [{ id: 0, type: '正常' }, { id: 1, type: '火焰报警' }, { id: 2, type: '烟雾报警' }, { id: 10, type: '故障' }],
  ...
  methods: {
    ...
    toPageDetail(id) {
      this.$router.push({ path: '/devrecord/firerecDetail', query: { id, device_type_id: this.$route.meta.roles[0] }})
    },
    getDeviceCameras() {
      this.isLoading = true
