    ...
    <div class="deviceList">
      <div class="list">
        ...
        >
          ...
          <el-table-column label="监测值" align="center" width="80px" >
            <template slot-scope="scope">
              <span>{{ scope.row.alarm_value }}m</span>
            </template>
          </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      alarm_state: [
        { name: '水浸报警', value: 0, per: 0, color: '#ea263d' },
      ...
      alarmOptions: [{ id: 0, type: '正常' }, { id: 1, type: '水浸报警' }],
  ...
  methods: {
    ...
    toPageDetail(id) {
      this.$router.push({ path: '/devrecord/waterDetail2', query: { id, device_type_id: this.$route.meta.roles[0] }})
    },
    deviceChange(id) {
