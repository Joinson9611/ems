        ...
        <el-form label-width="90px">
          ...
          <div class="infoItem">
            <el-form-item label="信号强度：" class="item-container">
              <span class="item-text">{{ waterDeviceInfo.signal_value ? waterDeviceInfo.signal_value + 'dBm' : '/' }}</span>
            </el-form-item>
          ...
          <div class="infoItem">
            ...
            <!-- <el-form-item label="监测值：" class="item-container">
              <span class="item-text">{{ waterDeviceInfo.alarm_value }}</span>
            </el-form-item> -->
          </div>
        </el-form>
      </el-card>
...
import { devicewater2sInfo } from '@/api/devicewater2s'
...
export default {
  ...
  methods: {
    ...
    getwaterDeviceInfo() {
      devicewater2sInfo({ project_id: this.selected_project_id, device_id: this.$route.query.id }).then(res => {
        this.waterDeviceInfo = res.data[0]
      }).catch(() => {})
    }
    // timeChange(time) {
